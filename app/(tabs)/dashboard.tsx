...
export default function Dashboard() {
  ...
  useEffect(() => {
      ...
      try {
        ...
        if (result.status === 'success') {
          ...
          const roleResponse = await fetch(
            'http://localhost/user_role_fetcher.php',
            {
              method: 'POST',
              headers: {
                'Content-Type': 'application/json',
          ...
          // Fetch role ID and store it in AsyncStorage
          const accessResponse = await fetch(
            'http://localhost/access_controller.php',
            {
              method: 'POST',
              headers: {
                'Content-Type': 'application/json',
          ...
          if (accessResult.role_id) {
            // Store role_id in AsyncStorage
            await AsyncStorage.setItem(
              'roleId',
              accessResult.role_id.toString()
            );
            console.log('Role ID stored:', accessResult.role_id);
          }
    ...
    const fetchUserCount = async () => {
      try {
        const response = await fetch('http://localhost/user_count.php');
        const result = await response.json();
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      const response = await fetch(
        'http://localhost/user_attendance_login.php',
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
  ...
  const handleLogout = async () => {
    ...
    try {
      ...
      const response = await fetch(
        'http://localhost/user_attendance_logout.php',
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
